...
public class BetaBreakersPageHeader
{
    ...
    public static Page home = new Page("home",
            ...
            "mega-menu-item-9",
            "mega-menu-item-9",
            "","#mega-menu-item-9 > a:nth-child(1)","");
    ...
    public static Page services = new Page("services",
            ...
            "mega-menu-item-31",
            "mega-menu-item-31",
            "","#mega-menu-item-31 > a:nth-child(1)","");
    ...
    public static Page whyTest = new Page("whyTest",
            ...
            "mega-menu-item-235",
            "mega-menu-item-235",
            "","#mega-menu-item-235 > a:nth-child(1)","");
    ...
    public static Page company = new Page("company",
            ...
            "mega-menu-item-29",
            "mega-menu-item-29",
            "","#mega-menu-item-29 > a:nth-child(1)","");
    ...
    public static Page blog = new Page("blog",
            ...
            "mega-menu-item-34",
            "mega-menu-item-34",
            "","#mega-menu-item-34 > a:nth-child(1)","");
    ...
    public static Page compatibility = new Page("compatibility",
            ...
            "mega-menu-item-109",
            services.topMenuId,
            "/html/body/div[1]/div[1]/footer/div/div/div[1]/div/ul/li[2]/a", "#mega-menu-item-109 > a:nth-child(1)","");
